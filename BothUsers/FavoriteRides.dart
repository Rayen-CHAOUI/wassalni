...
class FavoriteRides extends StatefulWidget {
  @override
  _FavoriteRidesState createState() => _FavoriteRidesState();
}

class _FavoriteRidesState extends State<FavoriteRides> {
  List<Ride> rides = [
    Ride(
      driver: Driver(
        familyName: 'Chui',
        firstName: 'Raen',
        email: 'chaorayn@gmail.com',
