...
import 'package:covoiturage/BothUsers/SearchDepannage.dart';
import 'package:covoiturage/BothUsers/SearchRide.dart';
import 'package:covoiturage/Backend/Endpoints.dart';
import 'package:covoiturage/PASSENGERS/ProfilePassenger.dart';
import 'package:flutter/material.dart';
import 'package:flutter_carousel_widget/flutter_carousel_widget.dart';
import 'package:http/http.dart' as http;

class MainPagePassenger extends StatefulWidget {
  const MainPagePassenger({Key? key}) : super(key: key);

  @override
  State<MainPagePassenger> createState() {
    return _MainPagePassengerState();
  }
}
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) {
                          return  const SearchDepannagePage();
                        }),
                      );
                    },
                    child: Container(
